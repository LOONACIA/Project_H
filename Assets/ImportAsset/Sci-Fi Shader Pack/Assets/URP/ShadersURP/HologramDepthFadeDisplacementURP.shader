...
Shader "SciFI_URP/HologramDepthFadeDisplacementURP"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Hologram1("Hologram", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult41 = (float2(0.0 , 0.1));
				float2 appendResult34 = (float2(WorldPosition.x , WorldPosition.y));
				float2 panner42 = ( 1.0 * _Time.y * appendResult41 + ( appendResult34 * _UV ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float temp_output_13_0 = ( 0.0 + (_ObjectLow + (_ShaderHologramDisplacement - 0.0) * (_ObjectHigh - _ObjectLow) / (1.0 - 0.0)) );
				float vpY9 = IN.ase_texcoord2.xyz.y;
				float smoothstepResult28 = smoothstep( ( temp_output_13_0 - 0.5 ) , ( temp_output_13_0 + 0.5 ) , vpY9);
				float mask38 = smoothstepResult28;
				float clampResult61 = clamp( pow( ( mask38 * _Const5 ) , 2.5 ) , 0.0 , 1.0 );
				float4 lerpResult67 = lerp( _FirstColor , _SecondColor , clampResult61);
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float fresnelNdotV26 = dot( IN.worldNormal, ase_worldViewDir );
				float fresnelNode26 = ( 0.0 + _Scale * pow( 1.0 - fresnelNdotV26, _Power ) );
				float clampResult46 = clamp( ( 1.0 - fresnelNode26 ) , 0.0 , 1.0 );
				#ifdef _INVERT1_ON
				float staticSwitch54 = clampResult46;
...
/*ASEBEGIN
Version=18912
-1920;0;1920;1019;3504.958;779.9807;2.205008;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-2438.419,1447.339;Float;False;Property;_ObjectLow;ObjectLow;2;0;Create;True;0;0;0;False;0;False;0;-0.8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;8;-2424.718,1523.533;Float;False;Property;_ObjectHigh;ObjectHigh;1;0;Create;True;0;0;0;False;0;False;0;1.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;7;-2561.268,1361.574;Float;False;Global;_ShaderHologramDisplacement;_ShaderHologramDisplacement;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-2150.49,1260.8;Inherit;False;Constant;_Const7;Const6;12;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-1779.352,705.5233;Float;False;Constant;_Const4;Const3;7;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-1937.675,1458.164;Float;False;Constant;_Const2;Const1;5;0;Create;True;0;0;0;False;0;False;0.2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-2409.425,140.6161;Float;False;Property;_Power;Power;4;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-2411.425,60.61636;Float;False;Property;_Scale;Scale;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;19;-2470.564,-293.3679;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;24;-1524.633,1089.903;Float;False;Constant;_Const3;Const2;5;0;Create;True;0;0;0;False;0;False;0.02;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-2224.702,-167.261;Float;False;Property;_UV;UV;9;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-2232.694,-68.97053;Float;False;Constant;_Panner1;Panner;5;0;Create;True;0;0;0;False;0;False;0.1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;44;-1463.405,-636.2358;Inherit;False;Property;_Const5;Const4;11;0;Create;True;0;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;48;-1779.729,342.6426;Float;False;Property;_DepthPower;DepthPower;7;0;Create;True;0;0;0;False;0;False;0;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;51;-1264.505,-570.2632;Inherit;False;Constant;_Const6;Const5;12;0;Create;True;0;0;0;False;0;False;2.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;53;-1566.288,-299.9434;Inherit;True;Property;_Hologram1;Hologram;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;54;-1559.515,49.83144;Float;False;Property;_Invert1;Invert;8;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-968.8985,-174.3388;Float;False;Property;_VertexMovement;VertexMovement;10;0;Create;True;0;0;0;False;0;False;0.02;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;60;-997.5425,-875.9712;Float;False;Property;_SecondColor;SecondColor;6;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;6.498019,6.498019,6.498019,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;62;-939.2584,-1059.955;Float;False;Property;_FirstColor;FirstColor;5;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,1.109601,8.574187,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=9A8BC87E9DFD70B6A8BC97632BA6F58C8BE2BBF0