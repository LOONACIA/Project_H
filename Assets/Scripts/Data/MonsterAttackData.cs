...
public class MonsterAttackData : ScriptableObject
{
    ...
    [field: SerializeField]
    public AttackData Skill { get; private set; }

    [field: SerializeField]
    public AttackData BlockPush { get; private set; }

    //빙의 데이터
    [field: SerializeField]
    public AttackData PossessedAttack { get; private set; }

    [field: SerializeField]
    public AttackData PossessedSkill { get; private set; }
