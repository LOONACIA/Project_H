...
namespace RenownedGames.AITreeEditor
{
    internal class DecoratorView : AuxiliaryView
    {
        ...
        private void HightlightLowPriority()
        {
            ...
            BehaviourTree.Traverse(parentNode, n =>
            {
                parentIndex++;
            });

            BehaviourTree.Traverse(parentNode.GetBehaviourTree().GetRootNode(), n =>
            {
                if (n.GetOrder() < parentIndex) return;
