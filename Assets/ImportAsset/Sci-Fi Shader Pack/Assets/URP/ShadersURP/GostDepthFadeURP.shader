...
Shader "SciFI_URP/GostDepthFadeURP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float fresnelNdotV7 = dot( WorldSpaceNormal, WorldSpaceViewDirection );
				float fresnelNode7 = ( 0.0 + _Scale * pow( 1.0 - fresnelNdotV7, _Power ) );
				float clampResult11 = clamp( ( 1.0 - fresnelNode7 ) , 0.0 , 1.0 );
				#ifdef _INVERT1_ON
				float staticSwitch13 = clampResult11;
				#else
				float staticSwitch13 = fresnelNode7;
				#endif
				...
				float distanceDepth10 = abs( ( screenDepth10 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthPower ) );
				float clampResult12 = clamp( distanceDepth10 , 0.0 , 1.0 );
				float clampResult16 = clamp( ( staticSwitch13 * clampResult12 ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=17700
88;44;1816;974;1709.487;441.2555;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;5;-1808.485,41.16792;Float;False;Property;_Scale;Scale;0;0;Create;True;0;0;False;0;1;0.8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;6;-1807.485,120.1678;Float;False;Property;_Power;Power;1;0;Create;True;0;0;False;0;1;0.84;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;7;-1603.17,33.70853;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;9;-1352.052,120.3362;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;8;-1479.129,289.2143;Float;False;Property;_DepthPower;DepthPower;3;0;Create;True;0;0;False;0;0;5.27;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;11;-1190.033,120.1742;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;10;-1260.189,269.7926;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;13;-1024.04,27.84842;Float;False;Property;_Invert1;Invert;4;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;12;-965.202,268.8815;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-771.4789,105.192;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;15;-638.7338,-153.2429;Float;False;Property;_EmissionColor;EmissionColor;2;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0.495283,0.6624865,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;16;-575.5189,106.7276;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;-181,-29;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;SciFI_URP/GostDepthFadeURP;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;0;Forward;12;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;0;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;12;Workflow;1;Surface;1;  Blend;0;Two Sided;1;Cast Shadows;1;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;Meta Pass;1;Override Baked GI;0;Vertex Position,InvertActionOnDeselection;1;0;5;True;True;True;True;True;False;;0
...
ASEEND*/
//CHKSM=C050F472DFAD87DD4AA1122AC295767111EEFF96